...
impl Theme for MusashiTheme {
    fn info(&self) -> ThemeInfo {
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#1a1a1a".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#faf9f7".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#2d2d2d".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#6b6b6b".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#4a4a4a".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("'Noto Serif JP', 'Georgia', serif".to_string()),
