...
impl Theme for DarkMinimalTheme {
    fn info(&self) -> ThemeInfo {
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#00ff88".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#0a0a0a".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#e0e0e0".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("#888888".to_string()),
        ...
        config_schema.insert(
            ...
            ConfigOption {
                option: toml::Value::String("Available for opportunities".to_string()),
